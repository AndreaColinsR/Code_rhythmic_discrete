function testing_Cortical_Data_as_RNN(region_name,figW,plot_supp)
...
for i_animal=1:Nanimals
    ...
    [Angle_disc_rhythm,Init_cond_t,Dist2Att] = RNNs_predictions(FR,idx_dir,idx_pos,idx_dist,exec,idx_Ncycle,plot_this_animal,column);
